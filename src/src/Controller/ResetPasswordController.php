...
//        dd($request);
        ...
        $emailConstraintNotBlank->message = $translator->trans('forgot_password.email.blank', array(), 'violation');
...
//
//            return $this->transmessage($translator, 'warning_message', array(), 'validation', 'forgot_password.email.violations', 'app_login');
        }
//
//        $validated = [];
//        $validated['mail'] = $input['email'];
//        dd($validated);
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('security@test.test', 'Security-Password-Reset'))
            ->to($user->getEmail())
